...
//
//import com.cleveroad.testrecycler.to_destroy.AnimationHelper;
//import com.cleveroad.testrecycler.to_destroy.AnimationHelperImpl;
//
//public class FanLayoutManagerOld3 extends RecyclerView.LayoutManager implements AnimationHelperImpl.AnimationHelperListener {
...
//
//    public FanLayoutManagerOld3(Context context) {
...
//            deselectItem(selectedViewPosition, 300);
//        }
...
//    }
//
//    private void selectItem(int position, int delay) {
//
...
//        }
//
//        deselectItem(selectedViewPosition, delay);
...
//        final View finalViewToSelect = viewToSelect;
//        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
//            @Override
//            public void onAnimationUpdate(ValueAnimator valueAnimator) {
//                float value = (float) valueAnimator.getAnimatedValue();
//                finalViewToSelect.setPivotX(finalViewToSelect.getWidth() / 2);
//                finalViewToSelect.setPivotY(finalViewToSelect.getHeight());
//
//                finalViewToSelect.setScaleX(value);
//                finalViewToSelect.setScaleY(value);
//            }
//        });
...
//    }
//
//    private void deselectItem(int position, int delay) {
//        if (selectedViewPosition != position || selectedViewPosition == -1) {
//            return;
//        }
...
//        ValueAnimator valueAnimator = ValueAnimator.ofFloat(1.5F, 1F);
//        final View finalViewToDeselect = viewToDeselect;
//        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
//            @Override
//            public void onAnimationUpdate(ValueAnimator valueAnimator) {
//                float value = (float) valueAnimator.getAnimatedValue();
//                finalViewToDeselect.setPivotX(finalViewToDeselect.getWidth() / 2);
//                finalViewToDeselect.setPivotY(finalViewToDeselect.getHeight());
//
//                finalViewToDeselect.setScaleX(value);
//                finalViewToDeselect.setScaleY(value);
//            }
//        });
...
//                return FanLayoutManagerOld3.this.computeScrollVectorForPosition(targetPosition);
//            }
//
//            @Override
